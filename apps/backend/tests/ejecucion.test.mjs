...
const RESULTADO = {
  ...
  /*
    ...
    misma cosa. Omitirla aqui daba un delta de +2 cuentas en la
    segunda ejecucion, que es lo que este comentario evita que
    alguien vuelva a diagnosticar desde cero.
  */
  clasificacionCuentas: {
    cuentasObjetivo: [
      { plataformaId: "x", handle: "jotalloretv" },
      { plataformaId: "facebook", handle: "juancristobal.lloretvaldivieso" }
    ],
    medios,
    instituciones: [],
    indeterminadas: []
